# Projeto para a criação de um sistema de gerenciamento de tarefas para a empresa Viex

- "O projeto inclui a criação de um sistema com backend, interface gráfica para administração e motoristas"

- "Além do mais o app irá criar um bot para a administração e a realização de interações com passageiros"
...
`create database viex-moove character set utf8mb4 collate utf8mb4_unicode_ci;`
...
## A API é executada neste endereço: **<http://localhost:8085s>**
